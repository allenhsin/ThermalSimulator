...
# endif
     ...
     && (! defined __cplusplus \
	 || (defined VERILOGSTYPE_IS_TRIVIAL && VERILOGSTYPE_IS_TRIVIAL)))
...
{
       0,     0,     3,     4,     7,    16,    17,    19,    23,    24,
      27,    31,    36,    40,    45,    50,    56,    60,    66,    68,
...
#if VERILOGDEBUG || YYERROR_VERBOSE || 1
...
static const char *const yytname[] =
{
  ...
  "list_of_module_instances", "list_of_module_connections",
...
{
       2,     0,     1,     0,    42,     3,     0,     5,     6,     0,
       0,     0,     8,     7,     0,     4,    20,    18,    19,    23,
      21,     0,    53,    50,    50,    54,    55,     9,     0,     0,
      24,     0,     0,     0,     0,    51,     0,    50,    50,     0,
      50,     0,     0,    22,     0,    36,    30,     0,     0,    28,
      57,     0,    47,     0,    50,     0,    12,     0,     0,    10,
...
do                                                              \
  if (yychar == YYEMPTY)                                        \
    ...
    {                                                           \
      yyerror (file_, YY_("syntax error: cannot back up")); \
      YYERROR;							\
    }								\
while (YYID (0))
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, Thermal::VerilogFile* file_)
#else
static void
yy_symbol_value_print (yyoutput, yytype, yyvaluep, file_)
    FILE *yyoutput;
    int yytype;
    YYSTYPE const * const yyvaluep;
    Thermal::VerilogFile* file_;
#endif
{
  FILE *yyo = yyoutput;
  YYUSE (yyo);
...
`--------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, Thermal::VerilogFile* file_)
#else
static void
yy_symbol_print (yyoutput, yytype, yyvaluep, file_)
    FILE *yyoutput;
    int yytype;
    YYSTYPE const * const yyvaluep;
    Thermal::VerilogFile* file_;
...
`------------------------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_reduce_print (YYSTYPE *yyvsp, int yyrule, Thermal::VerilogFile* file_)
#else
static void
yy_reduce_print (yyvsp, yyrule, file_)
    YYSTYPE *yyvsp;
    int yyrule;
    Thermal::VerilogFile* file_;
#endif
...
do {					\
  if (yydebug)				\
    yy_reduce_print (yyvsp, Rule, file_); \
} while (YYID (0))
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, Thermal::VerilogFile* file_)
#else
static void
yydestruct (yymsg, yytype, yyvaluep, file_)
    const char *yymsg;
    int yytype;
    YYSTYPE *yyvaluep;
    Thermal::VerilogFile* file_;
...
yyparse (YYPARSE_PARAM)
    void *YYPARSE_PARAM;
     ...
     || defined __cplusplus || defined _MSC_VER)
int
yyparse (Thermal::VerilogFile* file_)
#else
int
yyparse (file_)
    Thermal::VerilogFile* file_;
...
#line 216 "verilog.y"
    { 
            ...
            {
                (*it)->setModuleName((yyvsp[(1) - (4)].sval));
                (*it)->setParameterValues((yyvsp[(2) - (4)].conns));
            }

            (yyval.items) = new VerilogItems();
            (yyval.items)->insert((yyval.items)->end(), (yyvsp[(3) - (4)].instances)->begin(), (yyvsp[(3) - (4)].instances)->end());
            delete (yyvsp[(2) - (4)].conns);
            delete (yyvsp[(3) - (4)].instances);
        }
    break;
...
#line 230 "verilog.y"
    { 
            ...
            for (it = (yyvsp[(2) - (3)].instances)->begin(); it != (yyvsp[(2) - (3)].instances)->end(); ++it)
                (*it)->setModuleName((yyvsp[(1) - (3)].sval));

            (yyval.items) = new VerilogItems();
            (yyval.items)->insert((yyval.items)->end(), (yyvsp[(2) - (3)].instances)->begin(), (yyvsp[(2) - (3)].instances)->end());
            delete (yyvsp[(2) - (3)].instances);
        }
    break;
...
#line 270 "verilog.y"
    { 
            ...
            for (it = (yyvsp[(1) - (1)].exprs)->begin(); it != (yyvsp[(1) - (1)].exprs)->end(); ++it)
            {
                (yyval.conns)->push_back(new VerilogConn(NULL, *(*it)));
                delete *it;
            }
            delete (yyvsp[(1) - (1)].exprs);
        }
    break;
  ...
  if (!yyerrstatus)
    {
      ++yynerrs;
#if ! YYERROR_VERBOSE
      yyerror (file_, YY_("syntax error"));
#else
...
`-------------------------------------------------*/
yyexhaustedlab:
  yyerror (file_, YY_("memory exhausted"));
  yyresult = 2;
  /* Fall through.  */
#endif
