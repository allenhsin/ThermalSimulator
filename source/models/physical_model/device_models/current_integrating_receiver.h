...
{   
    ...
    private:
        ...
        SenseAmpState           _sa_current_bit_state;
        ...
        double                  _sa_current_bit_current_noise;
        double                  _sa_current_bit_pd_regen_start_delta_input_volt;
    };
